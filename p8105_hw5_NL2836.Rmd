...
- This plot shows how the power of the test (probability of rejecting a false null hypothesis) changes as the true value of μ increases. As the effect size (difference from the null hypothesis) increases, the power should also increase.

```{r}
mu_hat_plot
```

- This plot shows the average estimated mu_hate across all tests and for tests where the null was rejected. If the test is unbiased, the sample average of mu_hat for all tests should be approximately equal to the 
